DROP TABLE IF EXISTS output.region_states;

CREATE TABLE output.region_states(
    state CHAR(2) primary key, 
    region int
);

INSERT INTO output.region_states
VALUES ('MA',1), ('ME',1), ('CT',1),('RI',1),('NH',1),('VT',1),
('NY',2), ('NJ',2), ('PR',2), ('VI',2),
