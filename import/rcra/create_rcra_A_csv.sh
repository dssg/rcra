...
in2csv -e iso-8859-1 -f fixed -s $DICT_DIR/aln_area_event.csv $RCRA_DIR/a4.txt > $OUTPUT_DIR/aln_area_event.csv
...
in2csv -e iso-8859-1 -f fixed -s $DICT_DIR/aln_authority_citation_schema.csv $RCRA_DIR/a8.txt > $OUTPUT_DIR/aln_authority.csv
